...
describe('total likes', () => {
  ...
  test('when list has only a few blogs, equals the likes of that', () => {
    const result = listHelper.totalLikes(listWithFiveBlogs)
    expect(result).toBe(36)
  })

  test('most liked blog post is correct', () => {
  ...
  test('the author with the most posts is correct', () => {
  ...
  test('the author with the most likes is correct', () => {
